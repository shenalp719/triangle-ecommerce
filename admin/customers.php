...
// Get all customers
$customersResult = executeQuery("SELECT id, email, first_name, last_name, phone, company, created_at FROM users WHERE role = 'customer' ORDER BY created_at DESC");
...
<body>
    <div class="admin-container">
        <aside class="admin-sidebar">
            ...
            <a href="/triangle-ecommerce/admin/customers.php" class="admin-sidebar-item active">Customers</a>
