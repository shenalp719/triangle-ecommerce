        ...
        <div class="grid grid-4" id="products-grid">
            ...
            <div class="product-card"  data-category="frames">
                ...
                <div class="product-info">
                    ...
                    <div class="product-price">LKR 2000.00</div>
                    <button class="btn btn-primary btn-sm btn-block" onclick="app.addToCart(1, 'Frame Poster 8x10', 2000, 'https://images.unsplash.com/photo-1513519245088-0e12902e5a38?q=80&w=800&auto=format&fit=crop'); window.location.href='customizer-frame.php'">Customize</button>
                </div>
            </div>
            ...
            <div class="product-card" data-category="frames">
                ...
                <div class="product-info">
                    ...
                    <div class="product-price">LKR 3800.00</div>
                    <button class="btn btn-primary btn-sm btn-block" onclick="app.addToCart(2, 'Frame Poster 16x20', 3800, 'https://images.unsplash.com/photo-1513519245088-0e12902e5a38?q=80&w=800&auto=format&fit=crop'); window.location.href='customizer-frame.php'">Customize</button>
                </div>
            </div>
            ...
            <div class="product-card" data-category="drinkware">
                ...
                <div class="product-info">
                    ...
                    <div class="product-price">LKR 450.00</div>
                    <button class="btn btn-primary btn-sm btn-block" onclick="app.addToCart(3, 'Coffee Mug 11oz', 450, 'https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?q=80&w=800&auto=format&fit=crop'); window.location.href='customizer-mug.php?type=mug'">Customize</button>
                </div>
            </div>
            ...
            <div class="product-card" data-category="drinkware">
                ...
                <div class="product-info">
                    ...
                    <div class="product-price">LKR 550.00</div>
                    <button class="btn btn-primary btn-sm btn-block" onclick="app.addToCart(4, 'Coffee Mug 15oz', 550, 'https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?q=80&w=800&auto=format&fit=crop'); window.location.href='customizer-mug.php?type=mug'">Customize</button>
                </div>
            </div>
            ...
            <div class="product-card" data-category="apparel">
                ...
                <div class="product-info">
                    ...
                    <div class="product-price">LKR 1000.00</div>
                    <button class="btn btn-primary btn-sm btn-block" onclick="app.addToCart(5, 'T-Shirt Cotton 100%', 1000, 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?q=80&w=800&auto=format&fit=crop'); window.location.href='customizer-shirt.php?type=shirt'">Customize</button>
                </div>
            </div>
            ...
            <div class="product-card" data-category="apparel">
                ...
                <div class="product-info">
                    ...
                    <div class="product-price">LKR 1200.00</div>
                    <button class="btn btn-primary btn-sm btn-block" onclick="app.addToCart(6, 'T-Shirt Poly-Blend', 1200, 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?q=80&w=800&auto=format&fit=crop'); window.location.href='customizer-shirt.php?type=shirt'">Customize</button>
                </div>
            </div>
            ...
            <div class="product-card" data-category="headwear">
                ...
                <div class="product-info">
                    ...
                    <div class="product-price">LKR 500.00</div>
                    <button class="btn btn-primary btn-sm btn-block" onclick="app.addToCart(7, 'Baseball Cap', 500, 'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?q=80&w=800&auto=format&fit=crop'); window.location.href='customizer-cap.php?type=cap'">Customize</button>
                </div>
            </div>
            ...
            <div class="product-card" data-category="headwear">
                ...
                <div class="product-info">
                    ...
                    <div class="product-price">LKR 600.00</div>
                    <button class="btn btn-primary btn-sm btn-block" onclick="app.addToCart(8, 'Snapback Cap', 600, 'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?q=80&w=800&auto=format&fit=crop'); window.location.href='customizer-cap.php?type=cap'">Customize</button>
                </div>
            </div>
            ...
            ?>
                <div class="product-card" data-category="<?php echo strtolower(htmlspecialchars($row['category'])); ?>">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-price"><?php echo number_format($row['base_price'], 2); ?> LKR</div>
